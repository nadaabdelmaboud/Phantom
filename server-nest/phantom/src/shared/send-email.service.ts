    ...
    if (type === 'confirm') {
      mailOptions = {
        ...
        html:
          '<html><h1>  Hi,' +
          userName +
          ' 😊 </h1> <p> you should confirm your email to complete sign up </p> <h2> <a href="http://localhost:8080/confirm?token=' +
          message +
      ...
      mailOptions = {
        ...
        html:
          '<html><h1>  Hi,' +
          userName +
          ' 😊 </h1> <p> The email address on your Phantom account was just changed. Did you make this change?<br> if you need it change follow this like </p> <h2> <a href="http://localhost:8080/changeEmail?token=' +
          message +
      ...
      mailOptions = {
        ...
        html:
          '<html><h1>  Hi,' +
          userName +
          ' 😊 </h1> you reset this email to be your new email <br> please follow this link to confirm that </h2><h2><a href="http://localhost:8080/changeEmail?token=' +
          message +
